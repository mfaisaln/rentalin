                    ...
                    <div class="mdl-grid">
                        ...
                        ?>
                                <div class="materialert danger">
                                    <i class="material-icons">error_outline</i> <span>Login Gagal. Periksa kembali username dan password anda</span>
                                </div>
                        <?php
                              }
                        ?>
                        <form action="<?php echo base_url('login/aksi_login'); ?>" method="post">
                            <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                    <input class="mdl-textfield__input" type="text" id="e-mail" name="username">
                            ...
                            <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone submit-cell">
                                ...
                                <div class="mdl-layout-spacer"></div>
                                    <input type="submit"  class="mdl-button mdl-js-button mdl-button--raised color--light-blue"  value="SIGN IN" />
