                ...
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <div class="mdl-card__actions">
                            ...
                            <a href="<?php  $this->session->set_userdata('pesan', ''); echo base_url('Barang/tambah'); ?>" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-green pull-right">
                                Tambah
                            </a>
                        </div>
                    </div>
                    <div class="mdl-card__supporting-text no-padding">
                        <table class="mdl-data-table mdl-js-data-table">
                            ...
                            <tr>
                                ...
                                <th class="mdl-data-table__cell--non-numeric">Merek</th>
                                <th class="mdl-data-table__cell--non-numeric">Harga/Hari</th>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"><?php echo$data->nama_barang;?></td>
                                        ...
                                        <td class="mdl-data-table__cell--non-numeric"><?php echo$data->tahun;?></td>
                                        <td class="mdl-data-table__cell--non-numeric">
                                            <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-orange">Edit</button>
                                            <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-red">Delete</button>
                                        </td>
                                    </tr>
