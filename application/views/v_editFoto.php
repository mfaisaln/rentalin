                        ...
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                <h3>Ubah Foto ! <br>
                                    ...
                                    ?>
                                <form class="row contact_form" action="<?php echo base_url('Akun/UbahFoto'); ?>" method="post" novalidate="novalidate"  enctype="multipart/form-data">
                                    
                                    <div class="col-md-12 form-group p_star">
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                            <input type="file" class="custom-file-input form-control" id="customFile" name="gambar">
                                            <label class="custom-file-label form-control" for="customFile">Pilih file Foto</label>
                                            </div>
                                        </div>
                                    </div>
