                    ...
                    <div class="properties__button">
                        ...
                        <nav>                                                      
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Semua Barang</a>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    <div class="single-popular-items mb-50 text-center">
                                        ...
                                        <div class="popular-caption">
                                            <h3><a href="<?php echo base_url("Pinjam/detail_pinjaman/".$data->id_barang) ?>"><?php echo$data->nama_barang; ?></a></h3>
                                            <span>
                                            <?php
                                    ...
                                    <!-- <div class="col-md-12 form-group d-flex justify-content-center">
                                        <a href="catagori.html" class="btn view-btn1">Pinjam</a>
                                    </div> -->
                                </div>
                            <?php
                            if(($i) % $kolom== 0) {    
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-popular-items mb-50 text-center">
                                    <div class="popular-img">
                                        <img src="<?php echo site_url('assets2/img/gallery/popular4.png') ?>" alt="">
                                        <div class="img-cap">
                                            <span>Add to cart</span>
                                        </div>
                                        <div class="favorit-items">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-popular-items mb-50 text-center">
                                    <div class="popular-img">
                                        <img src="<?php echo site_url('assets2/img/gallery/popular5.png') ?>" alt="">
                                        <div class="img-cap">
                                            <span>Add to cart</span>
                                        </div>
                                        <div class="favorit-items">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-popular-items mb-50 text-center">
                                    <div class="popular-img">
                                        <img src="<?php echo site_url('assets2/img/gallery/popular6.png') ?>" alt="">
                                        <div class="img-cap">
                                            <span>Add to cart</span>
                                        </div>
                                        <div class="favorit-items">
