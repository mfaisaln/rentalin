                        ...
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                <h3>Welcome Back ! <br>
                                    ...
                                    ?>
                                <form class="row contact_form" action="<?php echo base_url('Register/aksi_tambah'); ?>" method="post" novalidate="novalidate"  enctype="multipart/form-data">
                                    <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" id="name" name="nama_user" value=""
                                            placeholder="Nama Lengkap">
                                    </div>
                                    <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" id="name" name="telp" value=""
                                    ...
                                    <div class="col-md-12 form-group p_star">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="file" class="custom-file-input form-control" id="customFile" name="ktp">
                                            <label class="custom-file-label form-control" for="customFile">Pilih file KTP</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 form-group p_star">
                                    ...
                                    <div class="col-md-12 form-group p_star">
                                        <textarea class="form-control" name="alamat" id="message" rows="1"placeholder="Alamat" ></textarea>
                                    </div>
                                    <div class="col-md-12 form-group p_star">
